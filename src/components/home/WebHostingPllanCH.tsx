...
const WebHostingPlanCH = () => {
  return (
    <div className=' flex flex-col items-center justify-center w-3/4 rounded-xl p-4 bg-gray-300 hover:bg-gray-400 mb-7 md:w-2/4 lg:w-1/4 ' >
         <h3 className=' text-3xl font-bold text-purple-900'>Cheap</h3>
         <strong className='text-3xl font-bold text-gray-900 my-5'>$1.89</strong>
         ...
         <div className='mt-6'>
            ...
            <div className='flex items-center text-green-700 mb-1 ps-3 '> <TiTimes/> Unlimited Bandwidth  </div>
...
export default WebHostingPlanCH