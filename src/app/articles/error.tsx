...
const Error = ({error,reset}:ErrorPageProps) => {
  return (
    <div className="pt-7 text-center ">
            ...
            <div className=" mb-32 mt-28 text-red-600  font-bold text-6xl  animate-bounce">
               404
            </div>
            ...
            <button onClick={() => reset() } className=" bg-blue-400 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded-full" >
                 Try again </button>
    <Link className="text-lx no-underline text-blue-700 block mt-6" href={'/'}>Go to Home Page</Link>
    </div>
  )
}
